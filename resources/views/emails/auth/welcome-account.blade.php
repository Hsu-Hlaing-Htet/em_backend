...
<body style="margin:0;padding:0;background-color:#F6EFE8;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">
        Your Rosewood Royale account has been created. Sign in with your temporary password.
    </div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="width:100%;max-width:600px;background-color:#FFFFFF;border:1px solid #E8DCD4;border-radius:16px;">
                    ...
                    <tr>
                        <td style="padding:24px 40px 0 40px;">
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#FBF7F3;border:1px solid #E8DCD4;border-radius:12px;">
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <p style="margin:0 0 12px 0;font-family:Georgia,'Times New Roman',Times,serif;font-size:14px;line-height:1.6;color:#6B5E58;">
                                            Login email
                                        </p>
                                        <p style="margin:0 0 20px 0;font-family:Georgia,'Times New Roman',Times,serif;font-size:16px;line-height:1.5;color:#1A1412;word-break:break-all;">
                                            {{ $loginEmail }}
                                        </p>
                                        <p style="margin:0 0 12px 0;font-family:Georgia,'Times New Roman',Times,serif;font-size:14px;line-height:1.6;color:#6B5E58;">
                                            Temporary password
                                        </p>
                                        <p style="margin:0;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,'Liberation Mono','Courier New',monospace;font-size:16px;line-height:1.5;color:#1A1412;word-break:break-all;">
                                            {{ $temporaryPassword }}
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" width="70%" style="width:70%;max-width:390px;">
                                <tr>
                                    <td align="center" bgcolor="#80152F" style="background-color:#80152F;border:2px solid #80152F;border-radius:6px;">
                                        ...
                                        >
                                            <span style="color:#ffffff;text-decoration:none;font-weight:400;">Login to Rosewood Royale</span>
                                        </a>
                                    </td>
                                </tr>
                            </table>
