...
<head>
    <meta charset="UTF-8">
    <title>Utility Bill {{ $document['header']['referenceNo'] ?? '' }}</title>
    ...
    <article id="pdf-print" class="pdf-sheet">
        <div class="pdf-document-lead">
            <header class="pdf-head">
                <div class="pdf-head-row">
                    ...
                    <div class="pdf-head-meta">
                        <div class="pdf-meta-item">
                            <span class="pdf-meta-label">Bill No.</span>
                ...
                <h1 class="pdf-doc-title">Utility Bill</h1>
                <div class="pdf-rule pdf-rule--accent"></div>
            </header>
        </div>

        @include('utilities.partials.document-body')
