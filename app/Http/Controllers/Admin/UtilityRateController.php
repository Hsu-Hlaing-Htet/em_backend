...
class UtilityRateController extends Controller
{
    ...
    public function update(UpdateUtilityRateRequest $request, UtilityRate $utilityRate, UtilityRateService $utilityRateService): JsonResponse
    {
